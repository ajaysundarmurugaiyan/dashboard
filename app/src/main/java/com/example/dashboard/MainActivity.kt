    ...
    Column(
        ...
        ConstraintLayout {
            ...
            Row(
                ...
                Image(painter = painterResource(id = R.drawable.baseline_person_pin_24),
            ...
            Row(verticalAlignment = Alignment.CenterVertically,
                ...
                Column(
                    ...
                    Text(
                        ...
                        fontWeight = FontWeight.Bold,
                        color = Color(android.graphics.Color.parseColor("#FF000000"))
                    )
                }
                Column(
                    modifier = Modifier
            ...
            )
            {
                Image(painter = painterResource(id = R.drawable.ic_1), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Inbox.route)
                            {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
            ...
            Column(
                ...
                Image(painter = painterResource(id = R.drawable.ic_2), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Maps.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
            ...
            Column(
                ...
                Image(painter = painterResource(id = R.drawable.ic_3), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Chats.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
            ...
            Column(
                ...
                Image(painter = painterResource(id = R.drawable.ic_4), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Report.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
               ...
               horizontalAlignment = Alignment.CenterHorizontally)
            {
                Image(painter = painterResource(id = R.drawable.ic_5), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Calender.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
                ...
                horizontalAlignment = Alignment.CenterHorizontally)
            {
                Image(painter = painterResource(id = R.drawable.ic_6), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Tips.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
                ...
                horizontalAlignment = Alignment.CenterHorizontally)
            {
                Image(painter = painterResource(id = R.drawable.ic_7), contentDescription = null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.Settings.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
                ...
                horizontalAlignment = Alignment.CenterHorizontally)
            {
                Image(painter = painterResource(id = R.drawable.ic_8), contentDescription =null,
                    Modifier
                        .padding(top = 8.dp, bottom = 4.dp)
                        .clickable {
                            navController.navigate(route = DashBoard.BottomNav.route) {
                                popUpTo(route = DashBoard.Home.route)
                            }
                        }
                        .background(
